...
# postings_clean |> write_csv("./raw_data/postings_clean.csv")
...
postings_clean |> 
  ...
  labs(title = "All industries are incredibly consolidated", 
       subtitle = "Percentage of LinkedIn jobs posted by the top 20 companies", 
       x = "", y = "")
...
postings_clean |> 
  ...
  kable(booktabs = TRUE, 
        caption = "Percent of LinkedIn postings by the five largest hirers per industry") |> 
  kable_classic_2("striped", 
                  full_width = FALSE)  
# save_kable("./plots/percent_postings.png")
